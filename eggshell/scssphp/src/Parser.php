...
class Parser
{
    ...
    protected function parseChunk()
    {
        ...
        if ($this->propertyName($name) && $this->literal(':')) {
            ...
            if ($this->literal('{')) {
                ...
                $foundSometheme = true;
            } elseif ($foundSometheme) {
                $foundSometheme = $this->end();
            }
    ...
    // div[yes=no]#sometheme.hello.world:nth-child(-2n+1)%placeholder
    ...
    // try to match sometheme on head of buffer
