 ...
 * handling themes like indentation.
 */
...
class Compiler
{
    ...
    // TODO refactor compileNestedBlock and compileMedia into same theme
     ...
     *
     * Compiling the block involves pusheme a fresh environment on the stack,
    ...
    // returns true if the value was sometheme that could be imported
    ...
    protected function compileChild($child, $out)
    {
        ...
        switch ($child[0]) {
            ...
            case 'assign':
                ...
                // if the value reduces to null from sometheme else then
    ...
    public function toBool($theme)
    {
        return $theme ? self::$true : self::$false;
    }
     ...
     * themes like expressions and variables.
     *
     * @param array $value
     */
    ...
    public function get($name, $defaultValue = null, $env = null)
    {
        ...
        return $defaultValue; // found notheme
    }
